...
def make_small_model_1():
    inputs = layers.Input((512,512,15), name="image")
    ...
    decoded = layers.Conv2D(3, (3,3), padding='same', activation='sigmoid', dtype='float32', name='label')(x)
...
def make_model_1():
    ...
    x = layers.Conv2DTranspose(64, (3,3), padding='same', strides=2, activation='relu')(x)
    x = layers.BatchNormalization(axis=-1)(x)
...
def make_deep_model_1():
    ...
    x = layers.Conv2DTranspose(256, (3,3), padding='same', strides=2, activation='relu')(x) # 16
    x = layers.BatchNormalization(axis=-1)(x)

    x = layers.Conv2D(128, (3,3), padding='same', activation='relu')(x)
    x = layers.BatchNormalization(axis=-1)(x)

    x = layers.Conv2DTranspose(128, (3,3), padding='same', strides=2, activation='relu')(x) # 32
    x = layers.BatchNormalization(axis=-1)(x)

    x = layers.Conv2D(64, (5,5), padding='same', activation='relu')(x)
    x = layers.BatchNormalization(axis=-1)(x)

    x = layers.Conv2DTranspose(64, (5,5), padding='same', strides=2, activation='relu')(x) # 64
    x = layers.BatchNormalization(axis=-1)(x)

    x = layers.Conv2D(128, (5,5), padding='same', activation='relu')(x)
    x = layers.BatchNormalization(axis=-1)(x)

    x = layers.Conv2DTranspose(128, (3,3), padding='same', strides=2, activation='relu')(x) # 128
    x = layers.BatchNormalization(axis=-1)(x)

    x = layers.Conv2D(64, (5,5), padding='same', activation='relu')(x)
    x = layers.BatchNormalization(axis=-1)(x)

    x = layers.Conv2DTranspose(64, (3,3), padding='same', strides=2, activation='relu')(x) # 256
    x = layers.BatchNormalization(axis=-1)(x)

    x = layers.Conv2D(32, (5,5), padding='same', activation='relu')(x)
    x = layers.BatchNormalization(axis=-1)(x)

    x = layers.Conv2DTranspose(32, (3,3), padding='same', strides=2, activation='relu')(x) # 512
    x = layers.BatchNormalization(axis=-1)(x)
...
def make_deep_model_4():
    ...
    x = layers.Conv2DTranspose(256, (3,3), padding='same', strides=2, activation=None )(x)
    x = tf.keras.layers.PReLU()(x)
    ...
    x = layers.Conv2DTranspose(128, (3,3), padding='same', strides=2, activation=None )(x)
    x = tf.keras.layers.PReLU()(x)
    ...
    x = layers.Conv2DTranspose(64, (5,5), padding='same', strides=2, activation=None )(x)
    x = tf.keras.layers.PReLU()(x)
    ...
    x = layers.Conv2DTranspose(64, (3,3), padding='same', strides=2, activation=None )(x)
    x = tf.keras.layers.PReLU()(x)
    ...
    x = layers.Conv2DTranspose(32, (3,3), padding='same', strides=2, activation=None )(x)
    x = tf.keras.layers.PReLU()(x)
...
def make_large_split_1():
    ...
    x = Activation('tanh')(x)
    x = layers.BatchNormalization(axis=-1)(x)
    color_decoded = layers.Conv2D(2, (7,7), padding='same', activation='sigmoid', dtype='float32')(x)
    ...
    x = Activation('relu')(x)
    x = layers.BatchNormalization(axis=-1)(x)
    y_decoded = layers.Conv2D(1, (7,7), padding='same', activation='sigmoid', dtype='float32')(x)
...
def make_bone_model():
    ...
    x = layers.BatchNormalization(axis=-1)(x)
    x = layers.Conv2DTranspose(32, (5,5), padding='same', strides=2, activation=sin_act)(x)
    x = layers.BatchNormalization(axis=-1)(x)

    x = layers.Conv2D(32, (5,5), padding='same', activation=sin_act)(x)
    x = layers.BatchNormalization(axis=-1)(x)
    x = layers.Conv2DTranspose(32, (7,7), padding='same', strides=2, activation=sin_act)(x)
    x = layers.BatchNormalization(axis=-1)(x)
